       ...
       <footer class="section novi-background footer-advanced bg-gray-700" style="background-color:black;background: linear-gradient(to bottom right, #287087 0%, #0d2d37 59%)">
              ...
              <div class="footer-advanced-aside">
                <div class="container">
                  <div class="footer-advanced-layout"><a class="brand" href="index.php"><img src="images/archstone_logo.png" alt="" width="115" height="34" srcset="images/logo-light-115x34.png 2x"/></a>
                    <!-- Rights-->
